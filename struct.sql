ALTER TABLE /*TABLE_PREFIX*/t_item ADD COLUMN b_show_paypal BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE /*TABLE_PREFIX*/t_item ADD COLUMN s_paypal VARCHAR (100) NOT NULL DEFAULT FALSE;
ALTER TABLE /*TABLE_PREFIX*/t_item ADD COLUMN b_accept_paypal BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE /*TABLE_PREFIX*/t_item ADD COLUMN b_accept_bank_transfer BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE /*TABLE_PREFIX*/t_item ADD COLUMN i_amount INT UNSIGNED NOT NULL DEFAULT 1;
ALTER TABLE /*TABLE_PREFIX*/t_user ADD COLUMN i_total_sales INT UNSIGNED NOT NULL DEFAULT 0;
ALTER TABLE /*TABLE_PREFIX*/t_user ADD COLUMN i_total_buys INT UNSIGNED NOT NULL DEFAULT 0;
